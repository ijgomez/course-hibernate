...
import org.course.hibernate.interceptors.MyEmptyInterceptor;
...
public class HibernateUtil {
	...
	static {
		try {
			...
			sessionFactory = new Configuration().setInterceptor(new MyEmptyInterceptor()).configure().buildSessionFactory();
